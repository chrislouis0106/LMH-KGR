...
# 数据集 WN18RR
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda   begin end 
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda  begin end 
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda  begin end 
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda   begin end
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda  begin end
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda  begin end
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda   begin end 
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda  begin end  
# python encoder_conv_3.py --dataset WN18RR --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda  begin end 



# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda 1  begin end 
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 1 begin end 
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda   begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda    begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda   begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 0 begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda 0  begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 1 begin end
# python encoder_conv_3.py --dataset WN18RR --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda 2 begin end



# 数据集 NELL-995  ubuntu
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda  1 begin end 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 1 begin end
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 1 begin end 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda  2 begin end 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 2 begin end 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 2 begin end
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda  3 begin 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 3 begin 
# python encoder_conv_3.py --dataset NELL-995 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda 3 begin end



# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda     begin end
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda    begin end
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda  2 begin 
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda     begin 
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda    begin
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda    begin
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda     begin
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda    begin end 
# python encoder_conv_3.py --dataset NELL-995 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda    begin



# 数据集 FB15K-237 对于fb数据的conv 3 全部完成； lidong 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda 1  begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 1 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 2 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 2  begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 3 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 3 begin end   6个
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2 --cuda   1 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 1 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda 2 begin end 



# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda   2 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda  3 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda  3 begin end  12个
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 1   begin end 
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda  1 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda  2 begin end
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda   2 begin end
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda  3 begin end 
# python encoder_conv_3.py --dataset FB15K-237 --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda  3 begin end 
...
class PathEncoder_Conv(nn.Module):
    def __init__(self,args,num_entity,num_relation):
        ...
        self.conv1 = nn.Conv2d(1,32,(5,3),1,0)
        self.fc = nn.Linear(32 *  (self.args.emb_2D_d1 * 3 -4) * (self.args.emb_2D_d2 -2), args.entity_dim)
    def forward(self, path):
        ...
        for j in range(path.shape[1]):
            ...
            h3 = h3.view(-1,1,self.args.emb_2D_d1, self.args.emb_2D_d2) 
            stack_inputs = torch.cat([h1,h2,h3],dim=2) # N * 1 * 30 * 20 
            stack_inputs = self.b1(stack_inputs)
            x = self.conv1(stack_inputs) # N * 32 * 26 * 18 
            # X = self.bn1(X)
            x = F.relu(x)
            # 特征层0.3
            x = self.feature_map_drop(x)  #  N * 32 * 26 * 18 ;
            ...
            x = torch.matmul(x.unsqueeze(1), h4.unsqueeze(2)).squeeze(2)
            # print(x.shape)  N * 1 ;
