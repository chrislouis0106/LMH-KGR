...
# 数据集 umls
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 0 begin end  
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 0  begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda 0  begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2 --cuda 0  begin end



# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda  0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 0 begin end
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset umls --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda 0 begin end 


# 数据集 kinship
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 0 begin end
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 0  begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 0 begin end
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --USEGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda 0 begin end 


# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 3  --cuda  0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 3  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 1  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 2 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 10 --ratio_valid_invalid 2  --cuda 0 begin end 
# python encoder_attn_2.py --dataset kinship --NOGTDM --number_multihop_valid_paths 20 --ratio_valid_invalid 2  --cuda  0 begin end 
...
class PathEncoder_Attn(nn.Module):
    def __init__(self, args, num_entity, num_relation):
        ...
        self.W2 = nn.Linear(args.entity_dim * 3  , 1)
        self.W3 = nn.Linear(args.entity_dim * 2, args.entity_dim)
        # batchnorm2d 1d 区别：
    ...
    def forward(self, path, epoch, index):
        ...
        h2 = torch.transpose(h2,1,2) # 同上
        h3 = torch.transpose(h3,1,2) # 同上
        b = torch.cat([h1, h2, h3], dim=2)  # N * 8 * 600;
        a = self.W2(b) # N * 8 * 1 ;
        ...
        if args.need_attn_values:
            ...
            if epoch == 100 and index == 0:
                with open(os.path.join(os.getcwd(), args.dataset+"_attn"+'.txt'),'a') as f:
                    ...
                    # f.write(str(a[:20]))
                    # f.write('\n')
        c = torch.cat([h1,h2,],dim=2) # N * 8 * 400
        c = self.W3(c) # N * 8 * 200;
        c = self.input_drop(c)
...
if __name__ == '__main__':
    ...
    # 加载模型并通过numpy保存训练后的实体和关系向量；
    # model = PathEncoder_Attn(args, len(entity2id), len(relation2id))
    # model_state_dict = torch.load(os.path.join(os.getcwd(), args.dataset + '_trained.tar'))
    # model.load_state_dict(model_state_dict)
    # with open(os.path.join(os.getcwd(), args.dataset + '_entity_pretrained_vec.txt'), 'w') as f:
    #     x = model.entity_emb.weight.data.numpy()
    #     np.savetxt(f, x)
    # with open(os.path.join(os.getcwd(), args.dataset + '_relation_pretrained_vec.txt'), 'w') as f:
    #     x = model.relation_emb.weight.data.numpy()
    #     np.savetxt(f, x)
    ...
    for epoch in range(args.epoch):
        ...
        print(train_data.shape,label_all.shape)
        ...
        if epoch > 100 and current_epoch_loss > np.min(loss_epoch[-100:]):
            break 
