...
class ComplEx(nn.Module):
    ...
    def forward(self, e1, r, kg):
        ...
        E1_real = kg.get_entity_embeddings(e1,-1)
        R_real = kg.get_relation_embeddings(r,-1)
        E2_real = kg.get_all_entity_embeddings(-1)
        E1_img = kg.get_entity_img_embeddings(e1, -1)
        R_img = kg.get_relation_img_embeddings(r,-1)
        E2_img = kg.get_all_entity_img_embeddings(-1)
    ...
    def forward_fact(self, e1, r, e2, kg):
        ...
        E1_real = kg.get_entity_embeddings(e1,-1)
        R_real = kg.get_relation_embeddings(r,-1)
        E2_real = kg.get_entity_embeddings(e2,-1)
        E1_img = kg.get_entity_img_embeddings(e1,-1)
        R_img = kg.get_relation_img_embeddings(r,-1)
        E2_img = kg.get_entity_img_embeddings(e2,-1)
...
class ConvE(nn.Module):
    ...
    def forward(self, e1, r, kg):
        E1 = kg.get_entity_embeddings(e1,-1).view(-1, 1, self.emb_2D_d1, self.emb_2D_d2)
        R = kg.get_relation_embeddings(r,-1).view(-1, 1, self.emb_2D_d1, self.emb_2D_d2)
        E2 = kg.get_all_entity_embeddings(-1)
    ...
    def forward_fact(self, e1, r, e2, kg):
        ...
        E1 = kg.get_entity_embeddings(e1, -1).view(-1, 1, self.emb_2D_d1, self.emb_2D_d2)
        R = kg.get_relation_embeddings(r, -1).view(-1, 1, self.emb_2D_d1, self.emb_2D_d2)
        E2 = kg.get_entity_embeddings(e2, -1)
...
class DistMult(nn.Module):
    ...
    def forward(self, e1, r, kg):
        E1 = kg.get_entity_embeddings(e1,-1)
        R = kg.get_relation_embeddings(r,-1)
        E2 = kg.get_all_entity_embeddings(-1)
